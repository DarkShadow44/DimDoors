...
public class DimensionalDoors {
    ...
    public static void init() {
		...
		ReloadListenerRegistry.register(ResourceType.SERVER_DATA, PocketLoader.getInstance());
		ReloadListenerRegistry.register(ResourceType.SERVER_DATA, LimboDecay.DecayLoader.getInstance());
...
//		TODO: Redo networking so this isn't needed
...
//		});
		...
		InteractionEvent.LEFT_CLICK_BLOCK.register(new UseBlockCallbackListener());
